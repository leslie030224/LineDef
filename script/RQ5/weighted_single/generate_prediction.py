...
def predict_defective_files_in_releases(dataset_name, target_epochs):
    ...
    for rel in test_rel:
        ...
        for filename, df in tqdm(test_df.groupby('filename')):
            ...
            code2d, word_edge, line_edge, word_edge_weight, line_edge_weight = prepare_code2d(code, line_lenth, True, weighted_graph)
            ...
            if not os.path.exists(save_file_path):
                with torch.no_grad():
                    ...
                    output, word_att_weights, line_att_weight, _ = model(codevec_padded_tensor, word_edge, line_edge, word_edge_weight, line_edge_weight)
